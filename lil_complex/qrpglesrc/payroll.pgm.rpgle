...
ctl-opt Dftactgrp(*no);
 ...
 // ***********************************************************
 //   SUBROUTINES USED
 //   ValidateFileToMaintainSelection - Edit application selection display (SELE
...
Dcl-Proc EmployeeMaintenance;
 ...
 // *******************************************************
 // Return true iff a previously record should be readded to file
